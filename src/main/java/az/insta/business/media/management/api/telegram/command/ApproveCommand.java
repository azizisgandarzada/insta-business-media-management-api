...
public class ApproveCommand implements Command {
    ...
    public static final Pattern COMMAND_PATTERN = Pattern.compile(RegexConstants.Command.APPROVE);
    ...
    public String getCommandPrefix() {
        return CommandConstants.APPROVE;
    }
